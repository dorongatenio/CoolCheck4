...
function create_tree_2() {
    ...
    //אם שאלה 1 היא כן
    let q5 = new Node("האם טמפרטורת הנוזל נמוכה מטמפרטורת הרוויה שבשעון לחץ HP? בצע בדיקה שטמפרטורה ביציאת המעבה נמוכה ב-4ᵒC -7ᵒC מטמפרטורה בשעון HP ( כן - אם נמוך מ-4ᵒC | לא - אם גבוה מ-3ᵒC)", null, null);
    //אם שאלה 5 היא כן
